...
* 수학명제 $G$ 가 거짓이라면
    ...
    + $G$가 거짓일 때 그 메타수학적 의미 $\rightarrow$ **괴델수 $g$ 를 갖는 명제** 는 증명 가능하다(참이다).
...
* 따라서 수학명제 $G$ 는 참이다. 
    ...
    + $G$가 참일 때 그 메타수학적 의미 참 $\rightarrow$ **괴델수 $g$ 를 갖는 명제** 는 증명 불가능하다.
...
* 수학명제 $G$ 가 거짓이라면 모순이 발생한다.

    + $G$의 괴델수는 $g$이므로, **괴델수 $g$ 를 갖는 명제** 는 거짓   
...
* 따라서 수학명제 $G$ 는 참이다. 
    ...
    + $G$는 참일 때 그 메타수학적 의미 $\rightarrow$ **괴델수 $g$ 를 갖는 명제** 는 증명 불가능하다.
